...
if __name__ == "__main__":
    ...
    print("only marginally significant, and it VANISHES once broad-sector x time trends are absorbed")
    print("(firm + sector x time). So the firm signal is a sector time trend, not identified tariff")
    print("incidence: the firm layer is not identified here (audit A3). The empirical weight sits on")
    print("the sector pass-through panel (beta=-2.18, robust) and the structural model.")
