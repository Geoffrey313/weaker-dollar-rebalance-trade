...
if __name__ == "__main__":
    ...
    print("With few clusters the wild-cluster bootstrap is the reliable inference. We find NO")
    print("EVIDENCE of a negative border-price offset: the coefficient is positive and not")
    print("significant under wild-cluster inference (robust to the small number of clusters).")
